...
for indication in data:
    ...
    for website in data[indication]:
        ...
        content += '\n<tr>'
        content += '<td><sub><a href="http://{0}" target="_blank">{0}</a></sub> <br/> <sub>{1}</sub> <br/> <sub>{2}</sub> <br/> <sub>{3}</sub> <br/> <img src="http://{0}/favicon.ico"/></td>'.format( website , data[indication][website]['drug']['generic'] , data[indication][website]['drug']['company'] , approval )
