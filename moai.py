...
for indication in data:
    ...
    content += '\n<tr>'
    content += '<td colspan="13"><strong>' + str(indication) + '</strong></td>'
    content += '</tr>'
    content += '\n<tr>'
    ...
    for website in data[indication]:
        ...
        content += '\n<tr>'
        content += '<td><sub><a href="http://{0}" target="_blank">{0}</a></sub></td>'.format( website )
        content += '<td><sub>{0}</sub></td>'.format( data[indication][website]['drug']['generic'] )
