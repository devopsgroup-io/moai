...
for indication in data:
    ...
    content += '<td><sub>Server<br/><img src="https://placehold.it/30x5/fee391?text=+"><br/><sub>ASN<br/><img src="https://placehold.it/30x5/ffffe5?text=+"></sub></td>'
    ...
    for website in data[indication]:
        ...
        content += '<td><sub>{0}</sub><br/><sub>{1}</sub></td>'.format( server , asn )
